...
const CampaignSidebar = ({ selectedWorksheet, onSelectWorksheet }) => {
  ...
  // Level 1: Metric Card selection (Opened, Sent, etc.)
  const [selectedMetric, setSelectedMetric] = useState(null); 
  
  // Level 2: Worksheet item selection (For deep dive view)
  ...
  // Mock data for the Worksheets list
  const mockDetailsList = [
    ...
    { id: 5, title: 'Untitled Worksheet 04', sent: 124, user: 'john', email: 'john@gmail.com' },
    { id: 6, title: 'Sale campaign 01', sent: 124, user: 'Doe', email: 'Doe@gmail.com' },
  ];

  // Mock data for Level 3 users list
  const mockWorksheetUsers = [
    { id: 1, user: 'john', email: 'john@gmail.com' },
    { id: 2, user: 'john1', email: 'johndoe@gmail.com' },
    { id: 3, user: 'user name', email: 'username@gmail.com' },
    { id: 4, user: 'Doe', email: 'Doe@gmail.com' },
    { id: 5, user: 'john', email: 'john@gmail.com' },
    { id: 6, user: 'john1', email: 'johndoe@gmail.com' },
  ];
  ...
  // Reset all deep views to go back to main grid
  ...
  return (
    <div className="w-80 h-screen bg-[#F8F9FA] border-r border-gray-200 flex flex-col flex-shrink-0">
      ...
      {activeTab === 'analytics' && (
        <div className="p-4 flex flex-col gap-4 overflow-y-auto bg-white flex-1 relative">
          
          {/* Header logic adjusts based on deep dive level */}
          ...
          {/* Conditional Rendering logic for 3 Levels */}
          {!selectedMetric ? (
            ...
            <>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                <h3 className="text-blue-600 text-sm font-medium">Reply percentage</h3>
            ...
            <div className="flex flex-col h-full -mt-2">
              ...
              <div className="mt-3 relative">
                ...
                <input 
                  ...
                  className="w-full pl-8 pr-3 py-1.5 text-xs border border-gray-300 rounded-md focus:outline-none focus:border-blue-400 focus:ring-1 focus:ring-blue-400"
                />
              </div>
              
              <div className="mt-3 flex-1 overflow-y-auto -mx-4">
                  ...
                  filteredList.map((item) => {
                    ...
                    return (
                      <div 
                        ...
                        className={`px-4 py-2.5 border-b border-gray-100 cursor-pointer transition-colors ${isSelected ? 'bg-gray-200' : 'hover:bg-gray-50'}`}
                      >
                        <div className="flex justify-between items-center mb-0.5">
                          {/* Yahan Title ko underline aur clickable banaya hai */}
                          <span 
                            onClick={(e) => {
            ...
            // LEVEL 3: DEEP DIVE WORKSHEET DETAIL (Screenshot 17-35-41.jpg)
            <div className="flex flex-col h-full -mx-4 -mt-4 absolute inset-0 bg-white">
              
              {/* Back Navigation Header */}
              <div className="px-4 py-3 border-b border-gray-100">
                <button 
                  onClick={() => setActiveWorksheetDetail(null)}
                  className="text-blue-600 text-[11px] font-semibold flex items-center gap-1 hover:underline mb-2"
                >
              ...
              {/* Users List with Conversation Buttons */}
              <div className="flex-1 overflow-y-auto bg-gray-50">
                {mockWorksheetUsers.map((u) => (
                  <div key={u.id} className="bg-white border-b border-gray-200 px-4 py-3">
                    ...
                    {/* View Conversation Button (Opens new tab as per Dev note) */}
                    <button 
